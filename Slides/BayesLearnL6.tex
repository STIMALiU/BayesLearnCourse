...
%$c \$
\item \textbf{\color{blue}Non-naive}: $p(x|c)$ can be $\mathcal{N}_{p}(\theta_{c},\Sigma_{c})$ (or more flexibly a \textbf{Mixture of normals}, see last module) (\textbf{Note}: $p=3$ in Ex.).
